...
void StiAnalyzer::BookHistograms()
{
  ...
  for(int etabin = 0; etabin < numEtaBins; etabin++)
  {
    errorEtaAcc[etabin] = new TH1F(Form("errorEtaAcc_%i",etabin),Form("Error for %.2f < #eta < %.2f; Error (cm); Counts",etaBinLow[etabin],etaBinHigh[etabin]),200,0,0.5);
    ...
    pullEtaAcc[etabin] = new TH1F(Form("pullEtaAcc_%i",etabin),Form("Pull for %.2f < #eta < %.2f; Pull; Counts",etaBinLow[etabin],etaBinHigh[etabin]),200,0,10);
    pullEtaRej[etabin] = new TH1F(Form("pullEtaRej_%i",etabin),Form("Pull for %.2f < #eta < %.2f; Pull; Counts",etaBinLow[etabin],etaBinHigh[etabin]),200,0,10);
    resEtaAcc[etabin] = new TH1F(Form("resEtaAcc_%i",etabin),Form("Residual for %.2f < #eta < %.2f; Dist to Close Hit (cm); Counts",etaBinLow[etabin],etaBinHigh[etabin]),200,0,2);
    resEtaRej[etabin] = new TH1F(Form("resEtaRej_%i",etabin),Form("Residual for %.2f < #eta < %.2f; Dist to Close Hit (cm); Counts",etaBinLow[etabin],etaBinHigh[etabin]),200,0,2);
  }

  // pT Bin Histograms
  for(int ptbin = 0; ptbin < numPtBins; ptbin++)
  {
    errorPtAcc[ptbin] = new TH1F(Form("errorPtAcc_%i",ptbin),Form("Error for %.2f < pT < %.2f; Error (cm); Counts",ptBinLow[ptbin],ptBinHigh[ptbin]),200,0,0.5);
    ...
    pullPtAcc[ptbin] = new TH1F(Form("pullPtAcc_%i",ptbin),Form("Pull for %.2f < pT < %.2f; Pull ; Counts",ptBinLow[ptbin],ptBinHigh[ptbin]),200,0,10);
    pullPtRej[ptbin] = new TH1F(Form("pullPtRej_%i",ptbin),Form("Pull for %.2f < pT < %.2f; Pull ; Counts",ptBinLow[ptbin],ptBinHigh[ptbin]),200,0,10);
    resPtAcc[ptbin] = new TH1F(Form("resPtAcc_%i",ptbin),Form("Residual for %.2f < pT < %.2f; Dist to Close Hit (cm)); Counts",ptBinLow[ptbin],ptBinHigh[ptbin]),200,0,2);
    resPtRej[ptbin] = new TH1F(Form("resPtRej_%i",ptbin),Form("Residual for %.2f < pT < %.2f; Dist to Close Hit (cm); Counts",ptBinLow[ptbin],ptBinHigh[ptbin]),200,0,2);
  }
